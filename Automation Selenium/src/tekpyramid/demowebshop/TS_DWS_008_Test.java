	...
	public void books() {
		...
		if (driver.getTitle().equals("Demo Web Shop. Login")) {
			...
			if (driver.findElement(By.xpath("//a[@class='account']")).getText().equals("vineethkumar2797@gmail.com")) {
				...
				if (driver.getTitle().equals("Demo Web Shop. Jewelry")) {
					System.out.println("Jewelry page has been Displayed Successfully");
				} else {
					System.out.println("Click on Jewelry Link");
				}
			}
		} 
